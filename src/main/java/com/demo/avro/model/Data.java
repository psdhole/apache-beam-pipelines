...
public class Data extends org.apache.avro.specific.SpecificRecordBase
  ...
  private static final org.apache.avro.io.DatumWriter<Data> WRITER$ =
      (org.apache.avro.io.DatumWriter<Data>) MODEL$.createDatumWriter(SCHEMA$);
  /** The Constant READER$. */
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Data> READER$ =
      (org.apache.avro.io.DatumReader<Data>) MODEL$.createDatumReader(SCHEMA$);
  /** The Invoice no. */
  @Deprecated public java.lang.CharSequence InvoiceNo;
  /** The Stock code. */
   ...
   */
  public Data(
      java.lang.CharSequence InvoiceNo,
      java.lang.CharSequence StockCode,
      java.lang.CharSequence Description,
      java.lang.CharSequence Quantity,
      java.lang.CharSequence InvoiceDate,
      java.lang.CharSequence UnitPrice,
      java.lang.CharSequence CustomerID,
   ...
   */
  public static com.demo.avro.model.Data.Builder newBuilder(
      com.demo.avro.model.Data.Builder other) {
   ...
   * Sets the invoice no.
   *
   * @param value the new invoice no
   */
   ...
   * Sets the stock code.
   *
   * @param value the new stock code
   */
   ...
   *
   * @param value the new invoice date
   */
   ...
   * Sets the unit price.
   *
   * @param value the new unit price
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Data>
    ...
    public Data build() {
      try {
        ...
        record.Quantity =
            fieldSetFlags()[3] ? this.Quantity : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.InvoiceDate =
            fieldSetFlags()[4]
                ? this.InvoiceDate
        ...
        record.Country =
            fieldSetFlags()[7] ? this.Country : (java.lang.CharSequence) defaultValue(fields()[7]);
        return record;
