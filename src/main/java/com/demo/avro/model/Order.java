...
public class Order extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final BinaryMessageEncoder<Order> ENCODER = new BinaryMessageEncoder<Order>(MODEL$, SCHEMA$);

	/** The Constant DECODER. */
	private static final BinaryMessageDecoder<Order> DECODER = new BinaryMessageDecoder<Order>(MODEL$, SCHEMA$);
	...
	/** The supplier id. */
	@Deprecated
	public java.lang.CharSequence supplier_id;

	/** The cust name. */
	@Deprecated
	public java.lang.CharSequence cust_name;
	 ...
	 *            the price
	 */
	public Order(java.lang.CharSequence order_id, java.lang.CharSequence customer_id,
			java.lang.CharSequence supplier_id, java.lang.CharSequence cust_name, java.lang.Integer item,
	 ...
	 * @return the com.demo.avro.model. order. builder
	 */
	public static com.demo.avro.model.Order.Builder newBuilder(com.demo.avro.model.Order.Builder other) {
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
		...
		public Order build() {
			try {
				...
				record.order_id = fieldSetFlags()[0] ? this.order_id
						: (java.lang.CharSequence) defaultValue(fields()[0]);
				record.customer_id = fieldSetFlags()[1] ? this.customer_id
						: (java.lang.CharSequence) defaultValue(fields()[1]);
				record.supplier_id = fieldSetFlags()[2] ? this.supplier_id
						: (java.lang.CharSequence) defaultValue(fields()[2]);
				record.cust_name = fieldSetFlags()[3] ? this.cust_name
						: (java.lang.CharSequence) defaultValue(fields()[3]);
				record.item = fieldSetFlags()[4] ? this.item : (java.lang.Integer) defaultValue(fields()[4]);
	...
	/** The Constant WRITER$. */
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumWriter<Order> WRITER$ = (org.apache.avro.io.DatumWriter<Order>) MODEL$
	...
	/** The Constant READER$. */
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<Order> READER$ = (org.apache.avro.io.DatumReader<Order>) MODEL$
	...
	public String toString() {
		return "Order [order_id=" + order_id + ", customer_id=" + customer_id + ", supplier_id=" + supplier_id
				+ ", cust_name=" + cust_name + ", item=" + item + ", price=" + price + "]";
	}
