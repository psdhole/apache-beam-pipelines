...
public class ParseAndGroupRecordDemo {
	...
	public static void main(String[] args) {
		...
		PCollection<KV<String, Integer>> parseAndConvertToKV = input.apply("Read file and map to key value pair",
				MapElements.via(new InferableFunction<String, KV<String, Integer>>() {
		...
		PCollection<String> sumUpValuesByKey = kvpCollection.apply("Calculate car orderCount group by brand name",
