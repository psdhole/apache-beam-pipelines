...
/**
 * The Class ReadFromDBWriteToDBProc.
 */
public class ReadFromDBWriteToDBProc {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(ReadFromDBWriteToDBProc.class);
	...
	public static void readAndWriteData() {
		...
		pipeline.apply(
				...
				.apply(JdbcIO.<KV<Integer, String>>write().withDataSourceConfiguration(JdbcIO.DataSourceConfiguration
						.create(DemoConstants.DEST_DB_DRIVER_CLASS, DemoConstants.DEST_DB_CONN_URL)
						.withUsername(DemoConstants.DEST_DB_USER_NAME).withPassword(DemoConstants.DEST_DB_SECRET))
						.withStatement(DemoConstants.DEST_INSERT_QUERY)
